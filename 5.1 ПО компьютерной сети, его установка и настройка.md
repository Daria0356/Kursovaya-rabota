...
* Устанавливаем необходимые предварительные компоненты:
  ...
  *  Устанавиливаем компоненты Server Media Foundation через PowerShell
...
* Установка
  ...
  * Выбираем "Установка ролей или компонентов" и кликаем по кнопке "Далее"
    ...
    ![image](https://serverspace.ru/wp-content/uploads/2020/06/57_3.png)

  * В "Компаненты" выбираем "Windows Server Backup"

     ![image](https://serverspace.ru/wp-content/uploads/2019/09/ahq1zji830o-450x294.jpg)
